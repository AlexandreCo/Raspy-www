<?php
$nb_month=$_GET['months'];
if($nb_month==''){
	$nb_month=365;
}

/*chart constante*/
$chart_title='Ecowatt Mois';
$chart_subtitle='Consommation par mois';
...
for($row = 0; $row < $arrlength; $row++) {
    ...
    $year=$array_date[1];
    $month=$array_date[0]-1;
    $value=$array_watt[$row]['kwatt'];
    echo ("	       [ Date.UTC( 20$year , $month , 1 , 0 , 0 , 0 ), $value ],\n") ;    
}
?>
            ],/*data*/
            tooltip: {
